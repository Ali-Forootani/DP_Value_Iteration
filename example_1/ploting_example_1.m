...
subplot(3,1,1)
hold on
plot(frequency_decision_BD(:,1)/st_size(1), 'LineWidth', 2, 'Marker', '+', 'MarkerSize', 5)
%plot(frequency_decision_net(:,1)/st_size(1), 'LineWidth', 3, 'Marker', 'x', 'MarkerSize', 10) % Uncomment if you want to include this
...
subplot(3,1,2)
hold on
plot(frequency_decision_BD(:,2)/st_size(1), 'LineWidth', 2, 'Marker', '+', 'MarkerSize', 5)
%plot(frequency_decision_net(:,2)/st_size(1), 'LineWidth', 3, 'Marker', 'x', 'MarkerSize', 10) % Uncomment if you want to include this
...
subplot(3,1,3)
hold on
plot(frequency_decision_BD(:,3)/st_size(1), 'LineWidth', 2, 'Marker', '+', 'MarkerSize', 5)
%plot(frequency_decision_net(:,3)/st_size(1), 'LineWidth', 3, 'Marker', 'x', 'MarkerSize', 10) % Uncomment if you want to include this
...
% subplot(4,1,4)
% hold on
% plot(frequency_decision_BD(:,4)/st_size(1), 'LineWidth', 3, 'Marker', 'x', 'MarkerSize', 10)
% plot(frequency_decision_net(:,4)/st_size(1), 'LineWidth', 3, 'Marker', 'x', 'MarkerSize', 10) % Uncomment if you want to include this
% xlabel('Time Slot', 'FontName', 'Times New Roman', 'FontSize', 20, 'FontWeight', 'bold')
