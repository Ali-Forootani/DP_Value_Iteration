...
plot(J_backward(:, 1), 'b-', 'LineWidth', 2, 'DisplayName', 'J_k(0)');
hold on;
plot(J_backward(:, 2), 'r--', 'LineWidth', 2, 'DisplayName', 'J_k(1)');

% Plot steady-state values using overbar Unicode character
yline(J_bar(1), ':k', 'LineWidth', 2, 'DisplayName', 'Steady-State J̄(0)');
yline(J_bar(2), ':k', 'LineWidth', 2, 'HandleVisibility','off');

% Plot bounds
yline(J_bar(1) + total_bound, '--r', 'LineWidth', 2, 'DisplayName', 'Upper Bound');
yline(J_bar(1) - total_bound, '--b', 'LineWidth', 2, 'DisplayName', 'Lower Bound');
yline(J_bar(2) + total_bound, '--r', 'LineWidth', 2, 'HandleVisibility','off');
yline(J_bar(2) - total_bound, '--b', 'LineWidth', 2, 'HandleVisibility','off');
...
%title('Backward Bellman Iteration with Periodic Perturbation', ...'FontName', 'Times New Roman', 'FontSize', 22, 'FontWeight', 'bold');
