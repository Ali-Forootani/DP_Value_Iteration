...
plot(J_backward(:, 1), '-', 'LineWidth', 2, 'DisplayName', 'J_k(0)');
hold on;
plot(J_backward(:, 2), '--', 'LineWidth', 2, 'DisplayName', 'J_k(1)');

yline(J_bar(1), ':k', 'LineWidth', 2, 'DisplayName', 'Steady-State J̄(0)');
yline(J_bar(2), ':k', 'LineWidth', 2, 'HandleVisibility', 'off');

yline(J_bar(1) + bound, '--r', 'LineWidth', 2, 'DisplayName', 'Upper Bound');
yline(J_bar(1) - bound, '--b', 'LineWidth', 2, 'DisplayName', 'Lower Bound');
yline(J_bar(2) + bound, '--r', 'LineWidth', 2, 'HandleVisibility','off');
yline(J_bar(2) - bound, '--b', 'LineWidth', 2, 'HandleVisibility','off');
