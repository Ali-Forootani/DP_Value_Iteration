...
%figure;
% Set up the figure
figure('Position', [100, 100, 650, 500]); % Adjust height for 5 subplots
set(gcf, 'Color', 'w');
plot(J_values_reversed(:, 1), 'b-o', 'DisplayName', 'State 1', 'LineWidth', 1);
hold on;
plot(J_values_reversed(:, 2), 'r-s', 'DisplayName', 'State 2', 'LineWidth', 1);
